...
- master — contains the source code of the project (React, components, styles).

- gh-pages — contains the production build of the project.
  Used for automatic deployment to GitHub Pages.
